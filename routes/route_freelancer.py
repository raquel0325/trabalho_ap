...
def buscar_freelancer():
    ...
    resultado = Freelancer.buscar_freelancer(
        busca=busca if busca else None,
        disponibilidade=disponibilidade if disponibilidade else None,
        preco_medio_min=preco_medio_min,
        preco_medio_max=preco_medio_max
    )
    ...
    for freelancer in resultado:
        ...
        if tipo_usuario == 'empresa' or tipo_usuario == 'funcionario':
            ...
            media_info = Avaliacao.calcular_media_avaliacoes(
            freelancer['id_freelancer']
            )
    ...
    return render_template('vaga/freelancer_listar.html', 
...
def cadastrar_freelance():
    ...
    print("5 - Dados recebidos:")
    print("Profissão:", profissao)
    print("Serviço:", servico_oferecido)
    print("Preço:", preco_medio)
    ...
    try:
        freelancer_id = FreelancerCRUD.inserir(
            profissao=profissao,
